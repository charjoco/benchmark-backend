...
export const BRANDS: BrandConfig[] = [
  ...
  },
  {
    ...
    scraperType: "shopify",
    // Sells men's and women's — filter by gender tags
    mensInclusionTags: ["gender:male", "gender:mens", "mens"],
    womensExclusionTags: ["gender:female", "gender:womens", "womens", "women", "women's"],
    colorOptionNames: ["Color"],
    newArrivalsHandle: "mens-new-arrivals",
    saleHandle: "mens-sale",
    categoryMappings: {
      jackets: { titleContains: ["jacket", "coat", "anorak", "windbreaker", "vest", "shell"] },
      ...
      sweaters: { titleContains: ["crew", "crewneck", "sweater", "fleece"] },
