...
The brand list (19 brands)
BYLT, ASRV, Buck Mason, Reigning Champ, Todd Snyder, Rhone, Mack Weldon, Vuori, Ten Thousand, Faherty, Holderness & Bourne, Linksoul, Paka, Taylor Stitch, TravisMathew, Greyson, Johnnie-O, Mott & Bow, DUER, AG Jeans, Paige.
...
Public Rec was removed on 2026-04-30 and replaced with nothing (pending).
...
3. Scrapes run hourly for all brands, on a flat schedule. Not tiered, not event-driven, not triggered by external signals. One cron, every hour, all 19 brands sequentially.
